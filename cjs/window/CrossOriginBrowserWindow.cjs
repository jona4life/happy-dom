...
class CrossOriginBrowserWindow extends EventTarget_js_1.default {
    ...
    constructor(target, parent) {
        ...
        this.location = new Proxy({}, {
            get: () => {
                throw new DOMException_js_1.default(
                // @ts-ignore
                `Blocked a frame with origin "${this.parent.location.origin}" from accessing a cross-origin frame.`, DOMExceptionNameEnum_js_1.default.securityError);
            },
            set: () => {
                throw new DOMException_js_1.default(
                // @ts-ignore
