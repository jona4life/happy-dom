...
const prepareWindow = (browserFrame, options) => {
    ...
    globalThis['open'] = function (url, target, features) {
        return WindowPageOpenUtility_js_1.default.openPage(globalThis.#browserFrame, {
            url,
            target,
            features
        });
    ...
    globalThis[PropertySymbol.location] = new Location_js_1.default(globalThis.#browserFrame, options?.url ?? 'about:blank');
    globalThis[PropertySymbol.history] = new History_js_1.default(globalThis.#browserFrame, globalThis);
    WindowBrowserContext_js_1.default.setWindowBrowserFrameRelation(globalThis, globalThis.#browserFrame);
