...
export default class WindowBrowserContext {
     ...
     */
    static setWindowBrowserFrameRelation(window: typeof globalThis, browserFrame: IBrowserFrame): void;
    /**
     * Assigns the window to a browser frame.
     *
     * @param window Window.
     * @param browserFrame Browser frame.
     */
    static removeWindowBrowserFrameRelation(window: typeof globalThis): void;
}
