...
export default class FetchBodyUtility {
     ...
     * @returns New stream.
     */
    static cloneBodyStream(window: typeof globalThis, requestOrResponse: {
     ...
     * @returns Promise.
     */
    static consumeBodyStream(window: typeof globalThis, body: ReadableStream | null): Promise<Buffer>;
    /**
